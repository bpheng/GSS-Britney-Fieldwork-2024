...
ucec_matrix <- confusionMatrix(ucec.prediction, new_ucec_data$msi)
ucec_df <- ucec_matrix$table

# Plotting the mosaic plot
mosaic(ucec_df,legend=FALSE,
       main = "UCEC Confusion Matrix Mosaic Plot")
