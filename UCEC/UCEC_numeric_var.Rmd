...
ucec_all <- readRDS("/Users/bpheng/GSS-Britney-Fieldwork-2024/data/UCEC All and Normal Samples/ucec_all.rds")

## Only the top 15 validated RAVs
sampleScore_sub <- read.csv("/Users/bpheng/GSS-Britney-Fieldwork-2024/data/UCEC All and Normal Samples/ucec_all_sampleScore.csv", row.names = 1)

## UCEC categorical variables
numTb <- read.csv("/Users/bpheng/GSS-Britney-Fieldwork-2024/data/UCEC All and Normal Samples/ucec_all_num.csv", row.names = 1)
```
